export default function CourseStatus() {
  return (
    <div
      id="wd-course-status"
      className="artboard artboard-demo p-6 max-w-xs min-w-56 bg-base-200 shadow-lg rounded-lg hidden lg:block"
    >
      ...
      <div className="space-y-2">
        ...
        <button className="btn btn-sm btn-secondary btn-outline w-full">
          Choose Home Page
        </button>
        <button className="btn btn-sm btn-secondary btn-outline w-full">
          View Course Stream
