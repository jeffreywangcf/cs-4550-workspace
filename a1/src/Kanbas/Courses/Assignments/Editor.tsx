...
export default function AssignmentEditor() {
  ...
  return (
    <form id="wd-assignments-editor" className="p-8 max-w-2xl space-y-8">
      <div>
        <label htmlFor="wd-name" className="block font-bold mb-1 text-xl">
          Assignment Name
        </label>
        <input
          id="wd-name"
      ...
      <div>
        <label htmlFor="wd-points" className="block font-bold mb-1 text-xl">
          Points
        </label>
        <input
          type="number"
      ...
      <div>
        <label htmlFor="wd-group" className="block font-bold mb-1 text-xl">
          Assignment Group
        </label>
        <select
          id="wd-group"
      ...
      <div>
        ...
        <label className="block font-bold mb-1 mt-1">
          ...
          {onlineEntryOptions.map(option => (
            <label key={option} className="inline-flex items-center">
              <input
                ...
                value={option}
                className="checkbox"
                checked={assignment.submissionType.onlineEntryOptions.includes(
                  option
                )}
              />
      ...
      <div>
        ...
        <div className="mb-4">
          <label htmlFor="wd-assign-to" className="block font-bold mb-1">
            Assign To
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label htmlFor="wd-due-date" className="block font-bold mb-1">
            Due
          </label>
          <input
            type="datetime-local"
        ...
        <div className="flex space-x-4 mb-4">
          <div className="w-1/2">
            <label htmlFor="wd-available-from" className="block font-bold mb-1">
              Available From
            </label>
            <input
              type="datetime-local"
          ...
          <div className="w-1/2">
            ...
            <input
              ...
              value={new Date(assignment.availableUntil)
                .toISOString()
                .slice(0, 16)}
              className="input input-bordered p-2 border border-base-300 rounded w-full"
            />
