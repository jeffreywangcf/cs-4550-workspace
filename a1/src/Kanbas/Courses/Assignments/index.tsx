            ...
            <div className="collapse-content p-0">
              <ul>
                {courseAssignments.map(assignment => (
                  <li key={assignment.id} className="wd-lesson p-4">
                    <div className="flex items-center">
                      ...
                      <div className="flex-grow text-left">
                        ...
                        <span className="block">
                          <a className="text-primary"> Multiple Modules</a> |{" "}
                          <a className="font-semibold">Available from</a>
                          {new Date(
                        ...
                        <span className="block">
                          <a className="font-semibold">Due </a>
