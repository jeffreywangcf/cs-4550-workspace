export default function Lab1() {
    return (
        <div id="wd-lab1" className="https://github.com/jeffreywangcfmax-w-4xl mx-auto space-y-8">
            ...
            <div id="wd-h-tag">
                ...
                <p className="text-gray-700 leading-relaxed">
                    ...
                    precedes.
                    For instance this paragraph is preceded by the heading Heading Tags. The font of the section
                    headings
            ...
            <div id="wd-p-tag">
                ...
                <p id="wd-p-1" className="mb-4 text-gray-700 leading-relaxed">
                ...
                <p id="wd-p-2" className="mb-4 text-gray-700 leading-relaxed">
                    This is the first paragraph. The paragraph tag is used to format
                    vertical gaps between long pieces of text like this one.
                </p>
                <p id="wd-p-3" className="mb-4 text-gray-700 leading-relaxed">
                    This is the second paragraph. Even though there is a deliberate white
                    gap between the paragraph above and this paragraph, by default
                    browsers render them as one contiguous piece of text as shown here on
                    the right.
                </p>
                <p id="wd-p-4" className="text-gray-700 leading-relaxed">
            ...
            <div id="wd-tables">
                ...
                <table className="min-w-full table-auto border-collapse border border-gray-300">
                    ...
                    <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2">2/3/21</td>
                    ...
                    <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2">2/10/21</td>
                        <td className="border border-gray-300 px-4 py-2">90</td>
                    </tr>
                    <tr>
                        <td className="border border-gray-300 px-4 py-2">Q3</td>
                        <td className="border border-gray-300 px-4 py-2">JavaScript</td>
                        <td className="border border-gray-300 px-4 py-2">2/17/21</td>
                        <td className="border border-gray-300 px-4 py-2">95</td>
                    </tr>
                    </tbody>
                    <tfoot className="bg-gray-200">
                    <tr>
                        <td className="border border-gray-300 px-4 py-2" colSpan={3}>Average</td>
                        <td className="border border-gray-300 px-4 py-2">90</td>
                    </tr>
                    </tfoot>
                </table>
            ...
            <div id="wd-images" className="space-y-4">
                ...
                <img id="wd-starship" className="rounded shadow-md" width="400px"
                     src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg"
                     alt="Starship"/>
                <p>Loading a local image:</p>
                <img id="wd-teslabot" className="rounded shadow-md w-96" src="/images/teslabot.png" alt="Teslabot"/>
            </div>
            ...
            <div id="wd-forms" className="space-y-4">
                ...
                <form id="wd-text-fields" className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="wd-text-fields-username" className="block">Username:</label>
                        <input id="wd-text-fields-username" className="border border-gray-300 p-2 rounded"
                               placeholder="jdoe"/>
                    </div>
                    <div>
                        <label htmlFor="wd-text-fields-password" className="block">Password:</label>
                        <input type="password" id="wd-text-fields-password"
                               className="border border-gray-300 p-2 rounded" value="123@#$asd"/>
                    </div>
                    <div>
                        <label htmlFor="wd-text-fields-first-name" className="block">First name:</label>
                        <input type="text" id="wd-text-fields-first-name"
                               className="border border-gray-300 p-2 rounded"/>
                    </div>
                    <div>
                        <label htmlFor="wd-text-fields-last-name" className="block">Last name:</label>
                        <input type="text" id="wwd-text-fields-last-name"
                               className="border border-gray-300 p-2 rounded" value="Wonderland"/>
                    </div>
                    <h5 className="text-lg font-semibold">Text Boxes</h5>
                    <label>Biography:</label>
                    <textarea id="wd-textarea" className="border border-gray-300 p-2 rounded w-full" cols={30}
                    ...
                    <button id="wd-all-good" className="px-4 py-2 bg-blue-500 text-white rounded"
                            onClick={() => alert("Life is Good!")}>Hello World!
                    </button>

                    <h5 className="text-lg font-semibold">File Upload</h5>
                    <input id="wd-upload" className="border border-gray-300 p-2 rounded" type="file"/>
                    <div id="wd-radio-buttons" className="space-y-4">
                        <h5 className="text-lg font-semibold">Radio Buttons</h5>
                        <label className="block font-medium mb-2">Favorite movie genre:</label>

                        <div className="flex items-center mb-2">
                            <input type="radio" name="radio-genre" id="wd-radio-comedy"
                                   className="radio checked:bg-blue-500"/>
                            <label htmlFor="wd-radio-comedy" className="ml-2">Comedy</label>
                        </div>

                        <div className="flex items-center mb-2">
                            <input type="radio" name="radio-genre" id="wd-radio-drama"
                                   className="radio checked:bg-blue-500"/>
                            <label htmlFor="wd-radio-drama" className="ml-2">Drama</label>
                        </div>

                        <div className="flex items-center mb-2">
                            <input type="radio" name="radio-genre" id="wd-radio-scifi"
                                   className="radio checked:bg-blue-500"/>
                            <label htmlFor="wd-radio-scifi" className="ml-2">Science Fiction</label>
                        </div>

                        <div className="flex items-center">
                            <input type="radio" name="radio-genre" id="wd-radio-fantasy"
                                   className="radio checked:bg-blue-500"/>
                            <label htmlFor="wd-radio-fantasy" className="ml-2">Fantasy</label>
                        </div>
                    </div>
                    ...
                    <div id="wd-checkboxes" className="space-y-4">
                        ...
                        <div className="flex items-center mb-2">
                            ...
                            <label htmlFor="wd-chkbox-comedy" className="ml-2">Comedy</label>
                        </div>

                        <div className="flex items-center mb-2">
                            <input type="checkbox" name="check-genre" id="wd-chkbox-drama"
                                   className="checkbox checked:bg-blue-500"/>
                            <label htmlFor="wd-chkbox-drama" className="ml-2">Drama</label>
                        </div>

                        <div className="flex items-center mb-2">
                            <input type="checkbox" name="check-genre" id="wd-chkbox-scifi"
                                   className="checkbox checked:bg-blue-500"/>
                            <label htmlFor="wd-chkbox-scifi" className="ml-2">Science Fiction</label>
                        </div>

                        <div className="flex items-center">
                            <input type="checkbox" name="check-genre" id="wd-chkbox-fantasy"
                                   className="checkbox checked:bg-blue-500"/>
                            <label htmlFor="wd-chkbox-fantasy" className="ml-2">Fantasy</label>
                        </div>
                    </div>
                    ...
                    <div id="wd-dropdowns" className="space-y-4">
                        ...
                        <label htmlFor="wd-select-one-genre" className="block font-medium mb-2">Favorite movie
                            genre:</label>
                        <select id="wd-select-one-genre" className="select select-bordered w-full max-w-xs">
                        ...
                        <label htmlFor="wd-select-many-genre" className="block font-medium mb-2">Favorite movie
                            genres:</label>
                        <select id="wd-select-many-genre" className="select select-bordered w-full max-w-xs" multiple>
                    ...
                    <div id="wd-other-fields" className="space-y-4">
                        ...
                        <label htmlFor="wd-text-fields-email" className="block font-medium mb-2">Email:</label>
                        <input type="email" id="wd-text-fields-email" placeholder="jdoe@somewhere.com"
                               className="input input-bordered w-full max-w-xs"/>

                        <label htmlFor="wd-text-fields-salary-start" className="block font-medium mt-4 mb-2">Starting
                            salary:</label>
                        <input type="number" id="wd-text-fields-salary-start" placeholder="1000" value="100000"
                               className="input input-bordered w-full max-w-xs"/>

                        <label htmlFor="wd-text-fields-rating" className="block font-medium mt-4 mb-2">Rating:</label>
                        <input type="range" id="wd-text-fields-rating" max="5" value="4"
                               className="range range-primary w-full max-w-xs"/>

                        <label htmlFor="wd-text-fields-dob" className="block font-medium mt-4 mb-2">Date of
                            birth:</label>
