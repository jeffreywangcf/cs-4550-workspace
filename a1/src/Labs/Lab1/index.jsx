    ...
    return (
        <div id="wd-lab1" className="max-w-4xl mx-auto space-y-8">
            ...
            <div id="wd-lists" className="space-y-4">
                ...
                <ol id="wd-your-favorite-recipe" className="list-decimal list-inside ml-6">
                    ...
                    <li>In a saucepan, melt 1 cup of butter with 1/2 cup of brown sugar.</li>
            ...
            <div id="wd-tables">
                ...
                <table className="min-w-full table-auto">
                    ...
                    <tr>
                        <td className="border border-base-300 px-4 py-2" colSpan={3}>Average</td>
                        <td className="border border-base-300 px-4 py-2">90</td>
                    </tr>
                    </tfoot>
                </table>
            ...
            <div id="wd-forms" className="space-y-4">
                ...
                <form id="wd-text-fields" className="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="wd-text-fields-username" className="border border-base-300 p-2 rounded"
                               placeholder="jdoe"/>
                    </div>
                    <div>
                        <label htmlFor="wd-text-fields-password" className="block">Password:</label>
                        <input type="password" id="wd-text-fields-password"
                               className="border border-base-300 p-2 rounded" value="123@#$asd"/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="wwd-text-fields-last-name"
                               className="border border-base-300 p-2 rounded" value="Wonderland"/>
                    </div>
                    <h5 className="text-lg font-semibold">Text Boxes</h5>
                    <label>Biography:</label>
                    <textarea id="wd-textarea" className="border border-base-300 p-2 rounded w-full" cols={30}
                    ...
                    <button id="wd-all-good" className="btn btn-primary px-4 py-2"
